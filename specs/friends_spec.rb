...
class TestFriends < MiniTest::Test
 ...
 def test_get_favourite_tv_show
  result = get_favourite_tv_show(@person5)
...
def test_likes_to_eat
  result = get_likes_to_eat(@person5, "spinach")
...
def test_add_friend
  adds_friend(@person2, "Scrappy-Doo")
...
def test_loan_money
  result = loaned_money()
  assert_equal(@person3[:monies](15), result)
end
Scooby gives Shaggy 5
20 = 15      1 = 6
...
.push
 ...
 concatinating means adding arrays together 
